...
<div class="d-flex align-items-center justify-content-between mb-3">
    <h3>Dashboard Global de la Carrera</h3>
    ...
    <div class="row mb-4">
        <div class="col-md-3">
            <div class="card card-custom blue"><div class="card-body">
                <h5>Total de estudiantes activos</h5>
                <p class="fs-3">{{ $totalEstudiantes }}</p>
            </div></div>
        </div>
        <div class="col-md-3">
    ...
    <div class="row mb-4">
        <div class="col-md-3">
            <div class="card"><div class="card-body">
                <h5>{{ $categorias['sin']['label'] }}</h5>
                <p class="fs-3 mb-1">{{ $categorias['sin']['count'] }} <small class="fs-6">({{ $categorias['sin']['percent'] }}%)</small></p>
                <small class="d-block">Motivo: {{ $categorias['sin']['motivo'] }}</small>
                <small class="d-block">Recomendación: {{ $categorias['sin']['recomendacion'] }}</small>
            </div></div>
        </div>
    </div>
